...
namespace API
{
    ...
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.MultipleApiVersions(
                         ...
                         (vc) =>
                         {
                             //vc.Version("V2", "YayYo API V2").Contact(cc => cc
                             //   .Name("YayYo")
                             //   .Url("https://yayyo.com")
                             //   .Email("support@yayyo.com"));
                             vc.Version("V1", "YayYo Safety API V1").Contact(cc => cc
                                .Name("YayYo")
                                .Url("https://yayyo.com")
                                .Email("support@yayyo.com"));
                         });
        ...
        {
            return $@"{AppDomain.CurrentDomain.BaseDirectory}\SwaggerXml\YayYo.XML";
        }
